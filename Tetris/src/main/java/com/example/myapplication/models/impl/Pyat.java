...
public class Pyat implements Shape {
    ...
    public int create(int[][] pole) {
        if (pole[0][5] == 0 && pole[0][4] == 0 && pole[1][3] == 0 && pole[1][4] == 0) {
            pole[0][5] = vid;
            pole[0][4] = vid;
            pole[1][4] = vid;
            pole[1][3] = vid;
    ...
    public boolean down(int[][] pole, int currentState) {
        ...
        switch (currentState){
            case 0:
                ...
                if(pole[fRow+1][fColumn+1]==0 && pole[fRow+2][fColumn-1]==0 && pole[fRow+2][fColumn]==0){
                    pole[fRow][fColumn]=0;
    ...
    public boolean right(int[][] pole, int currentState) {
        ...
        switch (currentState) {
            case 0:
                ...
                if (pole[fRow][fColumn+2] == 0 && pole[fRow + 1][fColumn+1] == 0) {
                    pole[fRow][fColumn] = 0;
                    pole[fRow + 1][fColumn - 1] = 0;
    ...
    public int turnLeft(int[][] pole, int currentState) {
        ...
        switch (currentState) {
            ...
            case 1:
                ...
                if (pole[fRow+2][fColumn] == 0 && pole[fRow + 1][fColumn+2] == 0) {
                    pole[fRow][fColumn] = 0;
                    pole[fRow + 1][fColumn] = 0;
                    pole[fRow + 2][fColumn] = vid;
                    pole[fRow + 1][fColumn+2] = vid;
